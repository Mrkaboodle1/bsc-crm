...
const NAV: NavItem[] = [
  ...
  { href: '/families', label: 'Families', icon: '👨‍👩‍👧', badge: 'Soon', section: 'main' },
  { href: '/students', label: 'Students', icon: '🧒', badge: 'Soon', section: 'main' },
  { href: '/classes', label: 'Classes', icon: '🎪', badge: 'Soon', section: 'main' },
  { href: '/stars', label: 'Star Ledger', icon: '⭐', badge: 'Soon', section: 'main' },

  { href: '/leads', label: 'Leads', icon: '🎯', badge: 'Soon', section: 'growth' },
